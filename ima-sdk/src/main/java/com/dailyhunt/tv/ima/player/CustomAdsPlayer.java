 ...
 * for custom player provided to IMA SDK
 *
 * @author raunak.yadav
 */
public interface CustomAdsPlayer {
   ...
   */
  void seekTo(long videoPosition);
   ...
   */
  void setMuteState(boolean muteState);
  ...
  default void setQualifiedForImmersive(Boolean state) {}

  default void setImmersiveSpan(int duration) {}
