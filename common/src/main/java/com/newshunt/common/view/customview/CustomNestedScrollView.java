 ...
 *
 * Highlighted Changes with Modified Source tag
 */
public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent,
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    ...
    /**
     * 1.For devices < 5.0, sometimes, ACTION_UP/CANCEL for previous touch does not get triggered
     * and hence, stopNestedScroll() would not have been called and mNestedScrollingParent of
     * (mChildHelper - NestedScrollingChildHelper) is not made null
     *
     * 2. If mNestedScrollingParent is not null on ACTION_DOWN (onInterceptTouchEvent),it leads to
     * issues with header and footer not hiding.
     *
     * 3. For devices >= 5.0, ACTION_UP/CANCEL is triggered properly and stopNestedScroll is called
     * and mNestedScrollingParent is set to null, so calling stopNestedScroll() again will not
     * lead to side-effects, because of null check in NestedScrollingChildHelper.stopNestedScroll();
     */
    ...
    switch (action & MotionEventCompat.ACTION_MASK) {
      ...
      case MotionEvent.ACTION_DOWN: {
        ...
        mVelocityTracker.addMovement(ev);
                ...
                */
        /**
         * Modified Source (Shrikant.Agrawal)
         * Reference :: http://stackoverflow.com/questions/31829976/onclick-method-not-working-properly-after-nestedscrollview-scrolled
         */
  ...
  protected boolean onRequestFocusInDescendants(int direction,
    ...
    // Modified:
    // This to fix the crash issue: We are getting direction = 0 in some devices, because of which
    // the function is throwing exception, So we are putting this logic in try catch block to
    // handle all such cases.
    // https://fabric.io/verse-innovation-pvt-ltd--bangalore/android/apps/com
    // .eterno/issues/5719c7d3ffcdc04250f02d70
    try {
