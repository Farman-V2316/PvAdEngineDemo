...
public class MASTAdConstants {
	...
	// this is the custom interface defined to capture the pageloaded event
	public static final String CUSTOM_METHOD_ADLOADED 	= "adLoaded";
	public static final String CUSTOM_METHOD_CLOSE 	= "close";  
	public static final String CUSTOM_METHOD_SET_STATE_CHANGE 	= "setState";
	public static final String CUSTOM_METHOD_OPEN 	= "open";  
	public static final String CUSTOM_METHOD_DIALOG_DISMISS 	= "dialogDismiss";  
	public static final String CUSTOM_METHOD_NEWSHUNT_COMMAND_AD = "newshuntCommandAd";
}
