...
<body>
    <div style="position: relative; display: block; max-width: 100%;">
        <div style="padding-top: 56.25%;">
            <video id="myPlayerID" data-video-id="DH_PLAYER_VIDEO_ID" data-account="5384493731001" data-player="Hk2DEMpYZ" data-embed="default" data-application-id class="video-js" controls style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px; width: 100%; height: 100%;">
        </video>
            <script src="http://players.brightcove.net/5384493731001/Hk2DEMpYZ_default/index.min.js"></script>
            ...
            <script type="text/javascript">
                ...
                videojs("myPlayerID").ready(function() {
                    ...
                    videojs("myPlayerID").on('volumechange', function(evt) {
                ...
                videojs('myPlayerID').on('loadedmetadata', function() {
                    ...
                    myPlayer.on('touchstart', function(evt) {
                        WebPlayerInterface.log('touch start');
                        WebPlayerInterface.onPlayerStateChangeWithPlayerCurTime(callBackNativeMapping['touchstart'], -1);
                    })
                ...
                function m_setControlState(state){
                    WebPlayerInterface.log('m_setControlState');
                    if (myPlayer != null) {
                        myPlayer.controls(state);
                    }
                }
                ...
                callBackNativeMapping['touchstart'] = 'touchstart'
            </script>
        </div>
    </div>
</body>
