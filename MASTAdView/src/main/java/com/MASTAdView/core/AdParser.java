...
final public class AdParser
{
	...
	public static final String PAGE_SWIPE_COUNT 							= "pageSwipeCount" ;
	
	public static final String AD_TITLEBAR_FLAG 							= "titleBar" ;
	public static final String AD_SKIP_TIMER 								= "skipTimer" ;
	public static final String PAGE_MAX_SWIPE_COUNT							= "maxPageSwipeCount";
