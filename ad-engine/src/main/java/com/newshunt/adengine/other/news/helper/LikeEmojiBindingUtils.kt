...
import com.newshunt.adengine.other.news.view.customview.LikeEmojiPopup
...
import com.newshunt.dataentity.news.analytics.NewsReferrer.STORY_DETAIL
...
//        }
        ...
        fun openLikesList(view: View, item: CommonAsset) {
            openLikesList(view, item, PageReferrer(STORY_DETAIL), null, null)
        }

        @JvmStatic
        fun openLikesList(view: View, item: CommonAsset, section: String?) {
            openLikesList(view, item, PageReferrer(STORY_DETAIL), section, null)
        }

        @JvmStatic
        fun openLikesList(view: View, item: CommonAsset, section: String?,
                          likeListPojo: LikeListPojo?) {
            openLikesList(view, item, PageReferrer(STORY_DETAIL), section, likeListPojo)
        }
