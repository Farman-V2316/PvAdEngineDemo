package com.newshunt.dhutil.view.recycleview.animator;
/*
...
import com.newshunt.dhutil.view.recycleview.helper.ViewHelper;
import com.newshunt.dhutil.view.recycleview.helper.AnimateViewHolder;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
  ...
  protected long getRemoveDelay(final RecyclerView.ViewHolder holder) {
    return Math.abs(getRemoveDuration());
  }
  ...
  protected long getAddDelay(final RecyclerView.ViewHolder holder) {
    return Math.abs(getAddDuration());
  }
