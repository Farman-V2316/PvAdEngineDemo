...
class ProfileNotificationIcon : ConstraintLayout, View.OnClickListener {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        val v = LayoutInflater.from(context).inflate(R.layout.profile_notification_layout, this, true)
