...
@Inject constructor(@Named("entityId") val entityId: String,
                    ...
                    private val memberDao: MemberDao) : BundleUsecase<NLResp> {
    override fun invoke(p1: Bundle): Observable<NLResp> {
        ...
        .map {
            ...
            memberDao.appendNextPage(fetchDao, fetchEntity, members, it.key)
            nlResp
        }
        .doOnError {
    ...
    companion object {
        const val TAG = "MembersNPUsecase"
    }
}